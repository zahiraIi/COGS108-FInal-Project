...
startup_data <- read_csv("startup_data.csv", show_col_types = FALSE)
dataset3 <- read_csv("dataset3_cleaned.csv", show_col_types = FALSE)
...
1. Place `startup_data.csv` and `dataset3_cleaned.csv` in your working directory
2. Install packages: `install.packages(c("dplyr", "tidyr", "purrr", "plotly", "readr", "lubridate", "stringr"))`
3. Click Knit or run all chunks
