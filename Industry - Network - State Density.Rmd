...
> startup_data <- read.csv(file_path, stringsAsFactors = FALSE)
> 
> # Prepare data
...
+         .groups = "drop"
+     ) %>%
+     filter(total >= 5)  # At least 5 companies
> 
...
+     )
> 
> ggsave("industry_trajectories.png", p1, width = 12, height = 8, dpi = 300, bg = "#1a1a1a")
> #NEW GRAPH
...
+     )
> 
> ggsave("network_trajectories.png", p2, width = 12, height = 8, dpi = 300, bg = "#1a1a1a")
> 
